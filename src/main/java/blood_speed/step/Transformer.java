...
public class Transformer extends Step<Images> {
    ...
    public static void main(String[] args) {
        List<Point> middleLine = FunctionHelper.readPointsList("data/tests/kris_2017_03_06_kr1_4/middle-line/v1_" + MiddleLineSelector.MIDDLE_FULL_POINTS_POSITION_FILENAME);
        Images data = BackgroundSelector.loadOutputData("data/tests/kris_2017_03_06_kr1_4/backgroundSelector/");
        int[][] sum = BmpHelper.readBmp("data/tests/kris_2017_03_06_kr1_4/backgroundSelector/sum-image.bmp");
        Step<Images> step = new Transformer(middleLine, data, sum, 12, "data/tests/kris_2017_03_06_kr1_4/transformedImages", 4, 1, 15);
        step.process();
    }
